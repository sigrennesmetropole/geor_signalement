...
const {changeSpatialAttribute, SELECT_VIEWPORT_SPATIAL_METHOD, updateGeometrySpatialField} = require('../../../MapStore2/web/client/actions/queryform');
const {CHANGE_MAP_VIEW} = require('../../../MapStore2/web/client/actions/map');
const {FEATURE_TYPE_SELECTED, QUERY, UPDATE_QUERY, featureLoading, featureTypeLoaded, featureTypeError, querySearchResponse, queryError} = require('../../../MapStore2/web/client/actions/wfsquery');
const {paginationInfo, isDescribeLoaded, layerDescribeSelector} = require('../../../MapStore2/web/client/selectors/query');
const {mapSelector} = require('../../../MapStore2/web/client/selectors/map');
const {authkeyParamNameSelector} = require('../../../MapStore2/web/client/selectors/catalog');
const {getSelectedLayer} = require('../../../MapStore2/web/client/selectors/layers');
const {selectedLayerSelector} = require('../../../MapStore2/web/client/selectors/featuregrid');
const {layerLoad} = require('../../../MapStore2/web/client/actions/layers');


const CoordinatesUtils = require('../../../MapStore2/web/client/utils/CoordinatesUtils');
const { addTimeParameter } = require('../../../MapStore2/web/client/utils/WFSTimeUtils');


const ConfigUtils = require('../../../MapStore2/web/client/utils/ConfigUtils');
const assign = require('object-assign');
const {spatialFieldMethodSelector, spatialFieldSelector, spatialFieldGeomTypeSelector, spatialFieldGeomCoordSelector, spatialFieldGeomSelector, spatialFieldGeomProjSelector} = require('../../../MapStore2/web/client/selectors/queryform');
const {changeDrawingStatus} = require('../../../MapStore2/web/client/actions/draw');
const {INIT_QUERY_PANEL} = require('../../../MapStore2/web/client/actions/wfsquery');
const {getJSONFeatureWA, getLayerJSONFeature} = require('../../../MapStore2/web/client/observables/wfs');
const {describeFeatureTypeToAttributes} = require('../../../MapStore2/web/client/utils/FeatureTypeUtils');
const notifications = require('../../../MapStore2/web/client/actions/notifications');

const {find} = require("lodash");

const FilterUtils = require('../../../MapStore2/web/client/utils/FilterUtils');
const filterBuilder = require('../../../MapStore2/web/client/utils/ogc/Filter/FilterBuilder');
const fromObject = require('../../../MapStore2/web/client/utils/ogc/Filter/fromObject');
const { read } = require('../../../MapStore2/web/client/utils/ogc/Filter/CQL/parser');
