...
import {ConfigurationData, ContextDescriptionPageResult, ContextType, GeographicType} from '../api/models';
import {AdministrationService, ContextDescriptionsService} from '../api/services';
...
export class ContextService {
    ...
    /**
     * Get the Background Map's Flow from the configuration
     * @return {FlowMap}
     */
    getBackgroundMapFlow(): Observable<ConfigurationData> {
        return this.administrationService.getConfiguration().pipe()
    }
}
