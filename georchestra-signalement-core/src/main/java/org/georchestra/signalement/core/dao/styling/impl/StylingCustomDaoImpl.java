...
public class StylingCustomDaoImpl extends AbstractCustomDaoImpl implements StylingCustomDao {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(StylingCustomDaoImpl.class);
	 ...
	 * @param builder le CriteriaBuilder
	 * @param criteriaQuery la requete
	 * @param root
	 */
	protected void buildQuery(StylingSearchCriteria searchCriteria, CriteriaBuilder builder,
