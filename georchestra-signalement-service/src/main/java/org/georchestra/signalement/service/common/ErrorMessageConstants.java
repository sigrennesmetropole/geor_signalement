...
public final class ErrorMessageConstants {
     ...
     */
    public static final String NULL_OBJECT = "serverErrors.nullData";

    /**
     * Error message when an non nullable attribute of an object is null
     * <br/><i>Example :</i> A User with a null login
     */
    public static final String NULL_ATTRIBUTE = "serverErrors.nullAttribute";

    /**
     * Error message when an attribute of an object is illegal
     * <br/><i>Example :</i> An UserRoleContext which has a not existing User
     */
    public static final String ILLEGAL_ATTRIBUTE = "serverErrors.illegalAttribute";

    /**
     * Error message when a data already exists
     */
    public static final String ALREADY_EXISTS = "serverErrors.alreadyExists";
     ...
     */
    public static final String NOT_AVAILABLE = "serverErrors.notAvailable";
     ...
     */
    public static final String USED_OBJECT = "serverErrors.usedObject";
}
