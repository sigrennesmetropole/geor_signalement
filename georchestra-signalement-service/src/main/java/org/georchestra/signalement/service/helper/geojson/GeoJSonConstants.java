...
public final class GeoJSonConstants {
	...
	public static final String FEATURE_TYPE_DESCRIPTION_PREFIX = "signalement.featureTypeDescription";

	public static final String ELEMENT_FORM_DEFAULT_PROPERTY = "elementFormDefault";

	public static final String TARGET_NAME_SPACE_PROPERTY = "targetNamespace";

	public static final String TARGET_PREFIX_PROPERTY = "targetPrefix";
	...
	public static final String CONTEXT_DESCRIPTION_LABEL = "contextDescriptionLabel";

	public static final String CONTEXT_DESCRIPTION_NAME = "contextDescriptionName";
