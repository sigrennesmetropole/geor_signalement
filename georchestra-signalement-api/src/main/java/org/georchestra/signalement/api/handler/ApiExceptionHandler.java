...
public class ApiExceptionHandler {
    ...
    /**
     * Capture les exceptions de type <code>AppServiceException.class</code> pour
     * la transformer en erreur json
     *
    ...
    public @ResponseBody
    ApiError handleBadRequestException(final ApiServiceException e) {
